...
const ArticleCard = ({ article, content, onReadMore, onEdit, index, language }) => {
  ...
  const { title, excerpt, category, time_ago, views, image_url, author, published_at } = article;
        ...
        <div className="text-xs text-muted-foreground mt-auto pt-3 border-t border-white/10 space-y-2">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <span className="flex items-center"><Eye className="h-3.5 w-3.5 mr-1" /> {views || 0}</span>
              {onEdit && (
